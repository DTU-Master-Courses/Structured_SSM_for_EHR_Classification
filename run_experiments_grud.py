...
output_dir = './SSSM/Structured_SSM_for_EHR_Classification/grud_output/'
...
for params in combinations:
    ...
    command = (
        ...
        f"--model_type=grud --epochs={params['epochs']} --batch_size={params['batch_size']} "
        f"--lr={params['lr']} --recurrent_dropout={params['recurrent_dropout']} "
